<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form id="chirp-form" method="POST" action="{{ route('chirps.store') }}">
            @csrf
            <textarea
                name="message"
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            if (response.ok) {
                ...
                // Insert the new chirp at the top
                //chirpList.prepend(newChirp);

                // Ensure the flex container updates correctly
                chirpList.style.display = "flex";
                chirpList.style.flexDirection = "column";
                chirpList.style.gap = "1rem"; // Adds spacing between chirps
            } else {
                console.error("Failed to send chirp");
            }
        });
    });
</script>
